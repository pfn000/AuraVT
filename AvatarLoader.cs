...
public class AvatarLoader : MonoBehaviour
{
    ...
    private async Task<AvatarInstance> LoadVRMAsync(string path, CancellationToken ct)
    {
        ...
        // Phase 3: Auto-remap shaders
        ReportProgress(0.96f, "Remapping shaders…");
        var remapper = vrmGameObject.AddComponent<ShaderRemapper>();
        remapper.RemapAll();
    ...
    private async Task<AvatarInstance> LoadGLBAsync(string path, CancellationToken ct)
    {
        ...
        // Phase 3: Auto-remap shaders
        var glbRemapper = holderGO.AddComponent<ShaderRemapper>();
        glbRemapper.RemapAll();
