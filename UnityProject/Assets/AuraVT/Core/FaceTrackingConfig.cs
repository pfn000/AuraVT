...
public class FaceTrackingConfig : ScriptableObject
{
    ...
    [Header("Built-in Tracking")]
    [Tooltip("Auto-select GPU/CPU backend based on hardware tier.")]
    public bool autoSelectBackend = true;

    public enum TrackingSource
    {
        /// <summary>Built-in webcam + MediaPipe ONNX. Zero external dependencies.</summary>
        BuiltIn,
        /// <summary>VMC/OSC protocol — VSeeFace, VTube Studio, MeowFace compatible.</summary>
        VMC,
        /// <summary>OpenSeeFace direct binary stream on UDP 11573.</summary>
        OpenSeeFace,
        /// <summary>No tracking — idle animation only.</summary>
        None
    }
}
